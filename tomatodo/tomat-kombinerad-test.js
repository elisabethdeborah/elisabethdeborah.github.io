...
function countDown(timeLeftX,minutesLeftX){
    ...
    let currentTime=timeLeft3--;
        ...
        if(currentTime>(timeLeft*60*60+minutesLeft*60)*0.875){
                ...
                background.style.background='linear-gradient(to bottom, rgba(255,255,255,1) 0%, rgba(50,205,50,0.86) 14%, rgba(50,205,50,0) 100%)';
                tomatStart.style.background='linear-gradient(to bottom, rgba(255,255,255,1) 0%, rgba(50,205,50,0.86) 14%, rgba(50,205,50,0) 100%)';
                background.style.transitionDuration='300ms';
